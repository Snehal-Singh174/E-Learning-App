...
class _QuizState extends State<QuizPage> {
  final databaseReference = Firestore.instance.collection("Materials");
  double xOffset = 0;
  double yOffset = 0;
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _container(0.0, 30.0, 10.0, Color(0xFF62B9BF), "Materials", "assets/images/material.png"),
            SizedBox(height: 50,),
            Container(
                      ...
                      return new ListView(
                        children: snapshot.data.documents.map((DocumentSnapshot document) {
                          return new Container(
                            ...
                            child: Center(
                              child: ListTile(
                                title: new Text(document['subject'],style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20,color: Colors.white),),
                                trailing: Icon(Icons.file_download,color: Colors.white,),
                                onTap: () async {
                                  if (await canLaunch(document["link"])) {
                                    await launch(document["link"],forceWebView: true);
                                  }
                                  else {
